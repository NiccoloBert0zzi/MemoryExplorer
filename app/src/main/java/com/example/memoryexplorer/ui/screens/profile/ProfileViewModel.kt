...
class ProfileViewModel: ViewModel(),KoinComponent {
    ...
    private val loginRepository = get<LoginRepository>()
    private var userEmail: String? = null

    private val favouriteRepository= get<FavouriteRepository>()
    ...
    init {
        viewModelScope.launch {
            userEmail = loginRepository.getEmail()
    ...
    private fun getProfile() {
        ...
        val ref: StorageReference = storage.getReference("Images/${userEmail}/profileImage")
        ...
        viewModelScope.launch {
            ...
            if(fav?.isEmpty() == true) {
                ...
                for (favourite in fav!!) {
                    val database = FirebaseDatabase.getInstance().getReference("memories/${favourite.memoryId}")
                    database.get().addOnSuccessListener { dataSnapshot ->
                        val favo = dataSnapshot.getValue(Memory::class.java)
                        favourites.add(favo!!)
